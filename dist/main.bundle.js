...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'register-token': this.apiBaseToken });
...
var VenueService = (function () {
    ...
    VenueService.prototype.postNewImage = function (image) {
        var formData = new FormData();
        formData.append('file', image, image.name);
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'Authorization': 'Bearer ' + this.authenticationService.token });
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: headers, body: formData });
        return this.http.post(this.authenticationService.apiBaseUrl + 'images', formData, options)
            .map(function (response) { return response.json(); });
    };
    VenueService.prototype.logOut = function () {
        this.authenticationService.logout();
    };
    return VenueService;
}());
...
module.exports = "<footer class=\"app-footer\">\n  <span><a href=\"#\">Bevvie</a> &copy; {{getCurrentYear()}}.</span>\n</footer>\n"
...
var AppFooterComponent = (function () {
    ...
    AppFooterComponent.prototype.getCurrentYear = function () {
